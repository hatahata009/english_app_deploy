...
def record_audio(audio_input_file_path):
    ...
    audio = audiorecorder(
        ...
        # pause_style={"color":"white", "background-color":"black"},
...
def play_wav(audio_output_file_path, speed=1.0):
    ...
    # --- 修正箇所: autoplay=True を追加 ---
    
    # Streamlitのプレーヤーで再生（autoplay=Trueで自動再生）
